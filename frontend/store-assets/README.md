...
|---|---|---:|---:|
| Apple iPhone 6.9-inch | `apple/iphone-6.9` | 1320 × 2868 PNG | 5 |
| Apple iPad 13-inch | `apple/ipad-13` | 2064 × 2752 PNG | 5 |
| Google phone | `google/phone` | 1080 × 1920 PNG | 5 |

The campaign is generated by deterministic application rendering. No generative-AI image or text model is used to create or edit these assets.
...
The final review should also visually inspect all 15 files at full size and store-thumbnail scale before any console upload.
